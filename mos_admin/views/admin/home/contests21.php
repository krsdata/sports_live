...
$qry12="SELECT  max(max1) as ct FROM `prize` where `contestid`='$contest_id'";
$result12=mysqli_query($con,$qry12);
while($rows12=mysqli_fetch_assoc($result12))
{
...
$arr[$ctccount]=$contest_id;
     ...
     echo '
<a href="contests3.php?match_id='.$match_id.'&contest_id='.$contest_id.'">
<div class="card btm mx-auto">
  ...
  if($diff1>0)
{
       echo '<div style="display:inline;float: right;"><a href="matchteam1.php?match_id='.$match_id.'&contest_id='.$contest_id.'">
...
<div class="navbar navbar-bottom fixed-bottom">
 ...
 <a href="matchteam.php?match_id='.$match_id.'" class="new2"><div class="header1">CREATE TEAM</div></a> 
 <a href="contests2.php?match_id='.$match_id.'" class="new2"><div class="header2">JOINED CONTESTS</div></a>
