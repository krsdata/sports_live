...
<div class="col float-left" style="width: 255px; padding:10px;">
  <span  style="color:black; font-size:20px; padding:10px;"><img src="images/android.jpg" width="150px" height="50px"></span>
    </div>
   </div>
   ...
   <a href="fantasypointst.php"> 
<div class="card btm mx-auto">
  <div class="row">

  <div class="col float-left" style="width: 255px; padding:10px;">
  <span  style="color:black; font-size:20px; padding:10px;"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fantasy Points</b></span>
    </div>
...
<div class="card btm mx-auto">
  ...
  <div class="col float-left" style="width: 255px; padding:10px;">
  <span  style="color:black; font-size:20px; "><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Help</b></span>
    </div>
...
<div class="card btm mx-auto">
  ...
  <div class="col float-left" style="width: 255px; padding:10px;">
  <span  style="color:black; font-size:20px; "><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Terms and Conditions</b></span>
    </div>
