...
<form class="form" method="post" action="sign1.php">
              
                  <div style="margin:auto; width:fit-content; "><h3 style="font-weight:bolder;">Login</h3></div>
...
<div class="col-lg-12">
 ...
 <div class="col-lg-12">
              <div class="form-group has-white">
                <label for="exampleInput1" class="bmd-label-floating" style="color:white;">Password</label>
