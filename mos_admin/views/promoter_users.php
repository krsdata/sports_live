    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        if($_SESSION["username"] != ""){
          $find = $_REQUEST['user_id'];
          require_once "../db/config.php";
          $sql = "SELECT user.username,user.mobile,user.email,user.email1,user.password,user.status FROM user JOIN refer1 ON user.email = refer1.userid  where `refer1`.`referral_userId` = '$find'";
