      ...
      ?>
        ...
        while($rows = mysqli_fetch_array($result))
        {
          ...
          <tr>
            ...
            <td><form action="join_contest" method="post">
                              <input type="hidden" name="mat_id" value="<?php echo $_POST['mat_id'];?>">
                              <input type="hidden" name="mat_title" value="<?php echo $_POST['mat_title'];?>">
                              <input type="hidden" name="mat_short_title" value="<?php echo $_POST['mat_short_title'];?>">
