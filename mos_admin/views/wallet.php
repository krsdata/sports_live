          ...
          <div class="row">
            ...
            <!-- <form role="form" action="" method="post" autocomplete="off">
              ...
              <div class="box-footer">
				...
				<?php
          require_once "../db/config.php";
          $sql = "SELECT wallet1.userid,wallet1.damount,wallet1.wamount,wallet1.bamount,user.username,user.email1,user.password FROM wallet1 JOIN user ON wallet1.userid=user.email where `wamount`>'199'";
