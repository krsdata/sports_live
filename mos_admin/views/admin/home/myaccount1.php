...
echo '<div class="col-md-8" style="color:black; font-size:20px;"><h3>Welcome '.$user_name.'</h3> 
<br />
<a href="deposit1.php"><input type="button" class="button" value="Deposit"></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="withdraw1.php"><input type="button" class="button" value="Withdraw"></a>
...
$qry1="SELECT * FROM `wallet1` WHERE `userid`='$user'";
$result1 = mysqli_query($con,$qry1);
    while ($rows1 = mysqli_fetch_array($result1)) 
    {
        $damount=$rows1['damount'];
 $wamount=$rows1['wamount'];
 $bamount=$rows1['bamount'];
    }

$total1= $damount+$wamount+$bamount;
...
<div class="card btm mx-auto">
  ...
  <span  style="color:black; font-size:20px; "><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Wallet Balance : '.$total1.'</b></span>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
...
<div class="card btm mx-auto">
  ...
  <div class="col float-left" style="width: 255px; padding:10px;">
  <span  style="color:black; font-size:20px; "><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Deposit Balance : '.$damount.'</b></span>
    </div>
...
<div class="card btm mx-auto">
  ...
  <div class="col float-left" style="width: 255px; padding:10px;">
  <span  style="color:black; font-size:20px; "><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Winning Balance : '.$wamount.'</b></span>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
...
<div class="card btm mx-auto">
  ...
  <div class="col float-left" style="width: 255px; padding:10px;">
  <span  style="color:black; font-size:20px; "><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bonus Balance : '.$bamount.'</b></span>
    </div>
