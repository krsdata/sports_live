...
?>
                   ...
                   <form action="selectedteam1.php" method="post"  onsubmit="return test()">
...
echo ' </font>
<input type="checkbox" id="'.$pname.'" value="'.$pid.',1,'.$pppoint.','.$tname.'" name="selectedplayers[]" class="fantasy" onclick="test1('.$totacount.')"> 
<label class="lab" for="'.$pname.'">
&#10004
</label>
</td>
</tr>
...
echo' </font>
<input type="checkbox" id="'.$pname.'" value="'.$pid.',2,'.$pppoint.','.$tname.'" name="selectedplayers[]" class="fantasy" onclick="test1('.$totacount.')"> 
<label class="lab" for="'.$pname.'">
&#10004
</label>
</td> </tr>
...
echo' </font>
<input type="checkbox" id="'.$pname.'" value="'.$pid.',3,'.$pppoint.','.$tname.'" name="selectedplayers[]" class="fantasy" onclick="test1('.$totacount.')"> 
<label class="lab" for="'.$pname.'">
&#10004
</label>
</td> </tr>
...
echo' </font>
<input type="checkbox" id="'.$pname.'" value="'.$pid.',4,'.$pppoint.','.$tname.'" name="selectedplayers[]" class="fantasy" onclick="test1('.$totacount.')"> 
<label class="lab" for="'.$pname.'">
&#10004
</label>
</td> </tr>
...
<div class="navbar navbar-bottom fixed-bottom">
  ...
  <div class="navicon">
      ...
      <div class="navicon">
     <button type="submit"  id="confirmButton1"  name="submit" class="btn btn-rose" disabled>Next</button></div>
      </div>
<div class="navicon">  
      </div>
     <div>
