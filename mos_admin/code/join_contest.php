...
if($tytttttt>$pass5)
{
	...
	{ 
		...
		$plyrs=$plyrs1.','.$plyrs2;
		$qry="SELECT rol_ply_id AS ply_id,ply_shortName,ply_fantasy_points FROM API_players JOIN API_player_role ON API_players.ply_id=API_player_role.rol_ply_id WHERE API_player_role.rol_name='wk' AND API_player_role.rol_mat_id=$user AND API_player_role.rol_ply_id IN ($plyrs)";
		...
		$qry="SELECT rol_ply_id AS ply_id,ply_shortName,ply_fantasy_points FROM API_players JOIN API_player_role ON API_players.ply_id=API_player_role.rol_ply_id WHERE API_player_role.rol_name='bat' AND API_player_role.rol_mat_id=$user AND API_player_role.rol_ply_id IN ($plyrs)";
		$result=mysqli_query($conn,$qry);
		$rows=mysqli_num_rows($result);
		while($rows=mysqli_fetch_assoc($result))
		{
		...
		$qry="SELECT rol_ply_id AS ply_id,ply_shortName,ply_fantasy_points FROM API_players JOIN API_player_role ON API_players.ply_id=API_player_role.rol_ply_id WHERE API_player_role.rol_name='all' AND API_player_role.rol_mat_id=$user AND API_player_role.rol_ply_id IN ($plyrs)";
		$result=mysqli_query($conn,$qry);
		$rows=mysqli_num_rows($result);
		while($rows=mysqli_fetch_assoc($result))
		{
		...
		$qry="SELECT rol_ply_id AS ply_id,ply_shortName,ply_fantasy_points FROM API_players JOIN API_player_role ON API_players.ply_id=API_player_role.rol_ply_id WHERE API_player_role.rol_name='bowl' AND API_player_role.rol_mat_id=$user AND API_player_role.rol_ply_id IN ($plyrs)";
		$result=mysqli_query($conn,$qry);
		$rows=mysqli_num_rows($result);
		while($rows=mysqli_fetch_assoc($result))
		{
