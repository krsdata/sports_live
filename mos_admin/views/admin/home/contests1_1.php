...
<a href="matchteam1.php?match_id='.$match_id.'&contest_id='.$contest_id.'">
...
<div class="header3">FULL</div></a></div>';
 ...
 <center>
<form action="contests3_1.php" method="post">
<input type="text" name="match_id" value="'.$match_id.'" hidden/>
<input type="text" name="contest_id" value="'.$contest_id.'" hidden/>
<button type="submit" class="button">
<div class="header31">View Contest</div>
</button></form>
</center>
   <br />
   </div>
