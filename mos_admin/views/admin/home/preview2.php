...
$query="SELECT * FROM `user_team` WHERE `user_team_id`='$team_id'";
...
<div class="navicon">
     <a href="contests31.php?match_id='.$match_id.'&contest_id='.$contest_id.'" class="btn btn-rose">Close Preview</a>
      </div>
   <div class="navicon">
     <a href="#"></a>
      </div>
