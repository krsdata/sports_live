      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
			...
			$sql = "SELECT * FROM transaction where `type` = 'withdraw' and `contestid` = '0' and `amount` >= 2000 order by date1";
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
    			...
    			$sql1 = "SELECT email1 FROM user WHERE `email` = '$userid'";
					...
					<tr>
					  ...
					  <td><a href="history?userid=<?php echo $rows['userid'];?>" class="btn btn-block btn-success" target="_blank" >Detail</a>
						</td>
					</tr>
					<?php
					$i++;
