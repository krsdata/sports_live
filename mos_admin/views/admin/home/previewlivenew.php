...
if(isset($_SESSION["val10"])&&isset($_SESSION["val11"])&&isset($_SESSION["val12"]))
{
$match_id=intval($_SESSION["val10"]);
$contest_id=intval($_SESSION["val11"]);
$team_id=intval($_SESSION["val12"]);
}
else
{
...
$query111="SELECT * FROM `pointstemptable` WHERE `playerid`='$value' and `matchid`='$match_id'";
