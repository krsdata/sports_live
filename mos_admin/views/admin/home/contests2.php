...
$ty1=((intval($contest_id11)+$ty)*3)-$ty;
     ...
     echo '
<a href="contests3t.php?trans1='.$ty1.'">
...
<div class="navbar navbar-bottom fixed-bottom">
 ...
 <a href="matchteamt.php" class="new2"><div class="header1">CREATE TEAM</div></a> 
 <a href="contests2t.php" class="new2"><div class="header2">JOINED CONTESTS</div></a>
