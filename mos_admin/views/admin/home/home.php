...
<br />
<center>Pick an upcoming match</center>
...
$ty1=((intval($match3)+$ty)*3)-$ty;
                            ...
                            echo' <a href="contests1t.php?trans1='.$ty1.'"><div class="card mx-auto">
...
<p class="text-center"><i style="font-size: 12px;" class="material-icons">alarm</i><i id="'.$match3.'"></i></p>
