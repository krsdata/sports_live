...
<?php
echo '
<a href="contests2_new.php?trans1='.$match_id.'">
...
$result11112=mysqli_query($conn,$query11112);
...
echo '
<a href="preview3_new.php?trans1='.$contest_id11.'&trans2='.$user12.'&trans3='.$match_id.'">
<div class="card btm mx-auto">
  <div class="row">
  <div class="col float-left" style="width: 255px;">
